...
{
    public partial class foFuncoes : Form
    {
        ...
        public foFuncoes(foMINIrpncalc frm1)
        {
            InitializeComponent();
            foMINI1 = frm1;
        ...
        private void btsen_MouseClick(object sender, MouseEventArgs e)
        {
            la0.Text = (double.Parse(la0.Text)*10.0).ToString();
        ...
        private void foFuncoes_MouseDown(object sender, MouseEventArgs e)
        {
